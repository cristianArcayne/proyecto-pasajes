...
router.register(r'choferes',       views.ConductorViewSet)   # ✅ AGREGADO
...
urlpatterns = [
    ...
    path('api/viajes-disponibles/',       views.listar_viajes),          # ✅ nombre correcto
    path('api/asientos-disponibles/',     views.asientos_disponibles),   # ✅ nombre correcto
