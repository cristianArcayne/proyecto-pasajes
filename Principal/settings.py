...
# Cargar archivo .env manualmente si existe para desarrollo local
...
# ✅ BASE DE DATOS: usa la variable de entorno DATABASE_URL de Render en producción,
# y de forma local intenta conectar a PostgreSQL usando .env o a SQLite como plan de respaldo.
