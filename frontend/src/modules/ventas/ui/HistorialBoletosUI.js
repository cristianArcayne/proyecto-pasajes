...
import { useConsultaBoletosController } from "../controllers/ConsultaBoletosController";

const HistorialBoletosUI = ({ styles, onSelectTicket }) => {
  const {
    ciBusqueda,
    setCiBusqueda,
    pasajesEncontrados,
...
export default HistorialBoletosUI;
